...
namespace Lab7B1
{
    public static class Program
    {
        ...
        {
            services.AddDbContext<ContactDbContext>(options => options.UseSqlServer("server=YUN;initial catalog=fuckyou;trusted_connection=True;App=EntityFramework;TrustServerCertificate=True"));
